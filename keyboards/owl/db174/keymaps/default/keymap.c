...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LGUI, KC_LALT,                                KC_SPC,                                 KC_RGUI, MO(_FL),     KC_RCTL,    KC_LEFT,  KC_DOWN,  KC_RIGHT),
    ...
    [_FL] = LAYOUT( /* FN */
        ...
        _______,  _______, _______,                                _______,                                _______,  _______,    _______,    RGB_RMOD,  RGB_TOG,  RGB_MOD)
};
// clang-format on
