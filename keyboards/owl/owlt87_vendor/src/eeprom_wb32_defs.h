...
#    if defined(WB32F3G71x9) || defined(WB32F3G71xB) || defined(WB32F3G71xC) || defined(WB32FQ95x9) || defined(WB32FQ95xB) || defined(WB32FQ95xC)
...
#    endif
#    if defined(WB32FQ95x9)
#        define FEE_MCU_FLASH_SIZE 96  // Size in Kb
#    elif defined(WB32FQ95xB)
#        define FEE_MCU_FLASH_SIZE 128  // Size in Kb
#    elif defined(WB32FQ95xC)
#        define FEE_MCU_FLASH_SIZE 256  // Size in Kb
#    endif
#endif
